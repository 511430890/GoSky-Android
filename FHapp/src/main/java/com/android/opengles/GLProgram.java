...
public class GLProgram {
    ...
    public void buildTextures(Buffer y, Buffer u, Buffer v, int width, int height) {
        ...
        if (videoSizeChanged) {
           ...
           // log.d("buildTextures videoSizeChanged: w=" + _video_width + " h=" + _video_height);
        }
    ...
    public int createProgram(String vertexSource, String fragmentSource) {
        ...
        // just check
        //log.d("vertexShader = " + vertexShader);
        //log.d("pixelShader = " + pixelShader);
        ...
        if (program != 0) {
            ...
            if (linkStatus[0] != GLES20.GL_TRUE) {
            	Log.e("X","Could not link program: ", null);
            	Log.e("X",GLES20.glGetProgramInfoLog(program), null);
    ...
    private int loadShader(int shaderType, String source) {
        ...
        if (shader != 0) {
            ...
            if (compiled[0] == 0) {
            	Log.e("X","Could not compile shader " + shaderType + ":", null);
            	Log.e("X",GLES20.glGetShaderInfoLog(shader), null);
