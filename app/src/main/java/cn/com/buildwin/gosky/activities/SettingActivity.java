...
public class SettingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    // Controls
    @BindView(R.id.setting_version_textView) TextView mVersionTextView;
    @BindView(R.id.setting_backButton) ImageButton backButton;
    @BindView(R.id.setting_listView) ListView mListView;
